namespace Tx.Network.UnitTests
{
    ...
    public class SnmpTrapTest
    {
        ...
        //{
        //    var testObject = new SnmpTrapV2C(testSnmpDatagram.ToSnmpEncodedByteArray().AsByteArraySegment());
        ...
        //    try
        //    {
        //        var testObject = new SnmpTrapV2C(V1trapBytes.AsByteArraySegment());
        ...
        //{
        //    var testObject = new SnmpTrapV1(V1trapBytes.AsByteArraySegment());
        ...
        //    try
        //    {
        //        var testObject = new SnmpTrapV1(testSnmpDatagram.ToSnmpEncodedByteArray().AsByteArraySegment());
        //        Assert.Fail("Should throw Exception for bad Version");
        //    }
        //    catch (InvalidDataException ivD)
        //    {
