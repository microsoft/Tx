...
from operationFailure in playback.GetObservable<OperationFailed>()
select new
{
	ActivityId = operationFailure.Header.ActivityId,
	MethodName = operationFailure.MethodName,
	AppDomain = operationFailure.AppDomain,
	OccurenceTime = operationFailure.OccurenceTime	
}