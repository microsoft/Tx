...
from etwException in playback.GetObservable<ThrowingEtwException>()
select new
{
	ActivityId = etwException.Header.ActivityId,
	ExceptionDetails = etwException.SerializedException,
	AppDomain = etwException.AppDomain,
	OccurenceTime = etwException.OccurenceTime
}